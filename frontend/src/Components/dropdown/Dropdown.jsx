  ...
  useEffect(() => {
    const GetHotelCities = async () => {
      const response = await axios.get(
        "http://localhost:3000/OperatingProperty/getHotelOperatingCity"
      );
    ...
    const getParkingCities = async () => {
      const response = await axios.get(
        "http://localhost:3000/OperatingProperty/getParkingOperatingCity"
      );
    ...
    const GetHotelAndParkingCities = async () => {
      const response = await axios.get(
        "http://localhost:3000/OperatingProperty/getHotelAndParkingOperatingCity"
      );
